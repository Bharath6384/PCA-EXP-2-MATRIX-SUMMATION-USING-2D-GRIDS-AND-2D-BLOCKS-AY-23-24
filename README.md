...
<img width="721" height="150" alt="image" src="https://github.com/user-attachments/assets/b4982c32-af39-4660-a89d-5eb760ef8c7c" />

## RESULT:
The host took 0.844350 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.027187 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
